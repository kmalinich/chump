...
class Receipt {
   ...
   */
	set acknowledgedAt(value) {
		this.properties.acknowledgedAt = value || null;
	}
   ...
   */
	set lastDeliveredAt(value) {
		this.properties.lastDeliveredAt = value || null;
	}
   ...
   */
	set expiresAt(value) {
		this.properties.expiresAt = value || null;
	}
   ...
   */
	set calledBack(value) {
		this.properties.calledBack = !!value;
	}
   ...
   */
	set calledBackAt(value) {
		this.properties.calledBackAt = value || null;
	}
}
